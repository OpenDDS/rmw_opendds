...
# Input variables:
#
# - DDS_ROOT (optional): When specified, header files and libraries
#   will be searched for in `${DDS_ROOT}/dds` and
#   `${DDS_ROOT}/lib` respectively.
#
# Output variables:
#
# - OpenDDS_FOUND: flag indicating if the package was found
# - OpenDDS_INCLUDE_DIRS: Paths to the header files
# - OpenDDS_LIBRARIES: Name to the C++ libraries including the path
# - OpenDDS_LIBRARY_DIRS: Paths to the libraries
# - OpenDDS_IDLPP: Path to the IDL preprocessor
#
# Example usage:
#
#   find_package(opendds_cmake_module REQUIRED)
#   find_package(OpenDDS MODULE)
#   # use OpenDDS_* variables
#
###############################################################################
