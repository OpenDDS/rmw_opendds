...
static const std::unordered_map<rmw_event_type_t, CORBA::ULong> mask_map{
  ...
  {RMW_EVENT_REQUESTED_QOS_INCOMPATIBLE, DDS::REQUESTED_INCOMPATIBLE_QOS_STATUS},
  {RMW_EVENT_LIVELINESS_LOST, DDS::LIVELINESS_LOST_STATUS},
  {RMW_EVENT_OFFERED_DEADLINE_MISSED, DDS::OFFERED_DEADLINE_MISSED_STATUS},
  {RMW_EVENT_OFFERED_QOS_INCOMPATIBLE, DDS::OFFERED_INCOMPATIBLE_QOS_STATUS},
};

CORBA::ULong get_status_kind_from_rmw(const rmw_event_type_t event_t)
{
