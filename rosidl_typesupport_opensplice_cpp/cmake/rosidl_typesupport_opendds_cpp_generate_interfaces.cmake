# Copyright 2018 Object Computing, Inc.
#
...
rosidl_generate_dds_interfaces(
  ...
  EXTENSION "rosidl_typesupport_opendds_cpp.rosidl_generator_dds_idl_extension"
)
...
foreach(_idl_file ${rosidl_generate_interfaces_IDL_FILES})
  ...
  if(_extension STREQUAL ".msg")
    ...
    list(APPEND _dds_idl_files
      "${_dds_idl_base_path}/${PROJECT_NAME}/${_parent_folder}/dds_opendds/${_name}_.idl")
  elseif(_extension STREQUAL ".srv")
    list(APPEND _dds_idl_files
      "${_dds_idl_base_path}/${PROJECT_NAME}/srv/dds_opendds/Sample_${_name}_Request_.idl")
    list(APPEND _dds_idl_files
      "${_dds_idl_base_path}/${PROJECT_NAME}/srv/dds_opendds/Sample_${_name}_Response_.idl")
  endif()
endforeach()
...
foreach(_idl_file ${rosidl_generate_interfaces_IDL_FILES})
  ...
  if(_extension STREQUAL ".msg")
    ...
    list(APPEND ${_var1}
      "${_output_path}/${_parent_folder}/dds_opendds/${_msg_name}_.h"
      "${_output_path}/${_parent_folder}/dds_opendds/${_msg_name}_.cpp"
      "${_output_path}/${_parent_folder}/dds_opendds/${_msg_name}_Dcps.h"
      "${_output_path}/${_parent_folder}/dds_opendds/${_msg_name}_Dcps.cpp"
      "${_output_path}/${_parent_folder}/dds_opendds/${_msg_name}_Dcps_impl.h"
      "${_output_path}/${_parent_folder}/dds_opendds/${_msg_name}_Dcps_impl.cpp"
      "${_output_path}/${_parent_folder}/dds_opendds/${_msg_name}_SplDcps.h"
      "${_output_path}/${_parent_folder}/dds_opendds/${_msg_name}_SplDcps.cpp"
      "${_output_path}/${_parent_folder}/dds_opendds/ccpp_${_msg_name}_.h")
    list(APPEND ${_var2}
      "${_output_path}/${_parent_folder}/${_header_name}__rosidl_typesupport_opendds_cpp.hpp"
      "${_output_path}/${_parent_folder}/dds_opendds/${_header_name}__type_support.cpp")
  elseif(_extension STREQUAL ".srv")
    list(APPEND _generated_srv_files "${_output_path}/srv/${_header_name}__rosidl_typesupport_opendds_cpp.hpp")
    list(APPEND _generated_srv_files "${_output_path}/srv/dds_opendds/${_header_name}__type_support.cpp")

    foreach(_suffix "_Request" "_Response")
      list(APPEND _generated_external_srv_files
        "${_output_path}/srv/dds_opendds/Sample_${_msg_name}${_suffix}_.h"
        "${_output_path}/srv/dds_opendds/Sample_${_msg_name}${_suffix}_.cpp"
        "${_output_path}/srv/dds_opendds/Sample_${_msg_name}${_suffix}_Dcps.h"
        "${_output_path}/srv/dds_opendds/Sample_${_msg_name}${_suffix}_Dcps.cpp"
        "${_output_path}/srv/dds_opendds/Sample_${_msg_name}${_suffix}_Dcps_impl.h"
        "${_output_path}/srv/dds_opendds/Sample_${_msg_name}${_suffix}_Dcps_impl.cpp"
        "${_output_path}/srv/dds_opendds/Sample_${_msg_name}${_suffix}_SplDcps.h"
        "${_output_path}/srv/dds_opendds/Sample_${_msg_name}${_suffix}_SplDcps.cpp"
        "${_output_path}/srv/dds_opendds/ccpp_Sample_${_msg_name}${_suffix}_.h")
    endforeach()
  else()
...
foreach(_pkg_name ${rosidl_generate_interfaces_DEPENDENCY_PACKAGE_NAMES})
  foreach(_idl_file ${${_pkg_name}_INTERFACE_FILES})
    ...
    if(_extension STREQUAL ".msg")
      ...
      get_filename_component(_parent_folder "${_parent_folder}" NAME)
      get_filename_component(_name "${_idl_file}" NAME_WE)
      set(_abs_idl_file "${${_pkg_name}_DIR}/../${_parent_folder}/dds_opendds/${_name}_.idl")
    ...
    elseif(_extension STREQUAL ".srv")
      ...
      set(_abs_idl_file "${${_pkg_name}_DIR}/../srv/dds_opendds/Sample_${_name}_Request_.idl")
      normalize_path(_abs_idl_file "${_abs_idl_file}")
      list(APPEND _dependency_files "${_abs_idl_file}")
      list(APPEND _dependencies "${_pkg_name}:${_abs_idl_file}")

      set(_abs_idl_file "${${_pkg_name}_DIR}/../srv/dds_opendds/Sample_${_name}_Response_.idl")
      normalize_path(_abs_idl_file "${_abs_idl_file}")
      list(APPEND _dependency_files "${_abs_idl_file}")
      list(APPEND _dependencies "${_pkg_name}:${_abs_idl_file}")
    endif()
...
configure_file(
  "${rosidl_typesupport_opendds_cpp_TEMPLATE_DIR}/visibility_control.h.in"
