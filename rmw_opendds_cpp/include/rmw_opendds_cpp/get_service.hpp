...
#ifndef RMW_OPENDDS_CPP__GET_SERVICE_HPP_
#define RMW_OPENDDS_CPP__GET_SERVICE_HPP_
...
/// Return a native OpenDDS replier handle for the request.
/**
 ...
 *
 * \return native OpenDDS replier handle if successful, otherwise `NULL`
 */
...
#endif  // RMW_OPENDDS_CPP__GET_SERVICE_HPP_
