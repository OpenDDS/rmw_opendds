...
#ifndef RMW_OPENDDS_CPP__GET_CLIENT_HPP_
#define RMW_OPENDDS_CPP__GET_CLIENT_HPP_
...
/// Return a native OpenDDS requester handle for the request.
/**
 ...
 *
 * \return native OpenDDS requester handle if successful, otherwise `NULL`
 */
...
#endif  // RMW_OPENDDS_CPP__GET_CLIENT_HPP_
