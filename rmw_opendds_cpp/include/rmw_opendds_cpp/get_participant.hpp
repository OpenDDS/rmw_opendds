...
/// Return a native OpenDDS participant handle.
/**
 ...
 *
 * \return native OpenDDS participant handle if successful, otherwise `NULL`
 */
...
#endif  // RMW_OPENDDS_CPP__GET_PARTICIPANT_HPP_
