  ...
  const rmw_qos_profile_t * qos_profile)
{
  ...
  void * buf = nullptr;
  OpenDDSStaticServiceInfo * service_info = nullptr;
...
fail:
  ...
  if (service_info) {
    RMW_TRY_DESTRUCTOR_FROM_WITHIN_FAILURE(
      service_info->~OpenDDSStaticServiceInfo(), OpenDDSStaticServiceInfo)
...
rmw_destroy_service(rmw_node_t * node, rmw_service_t * service)
{
  ...
  OpenDDSStaticServiceInfo * service_info = static_cast<OpenDDSStaticServiceInfo *>(service->data);
  ...
  if (service_info) {
    ...
    RMW_TRY_DESTRUCTOR(
      service_info->~OpenDDSStaticServiceInfo(),
      OpenDDSStaticServiceInfo, result = RMW_RET_ERROR)
    rmw_free(service_info);
